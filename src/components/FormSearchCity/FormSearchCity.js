...
const FormSearch = ({ handleSubmit }) => {
  ...
  return (
    <form className="mt-6 flex" onSubmit={onSubmit}>
      ...
      <button
        type="submit"
        className="ml-4 flex-shrink-0 px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-sky-500 hover:bg-sky-600 focus:outline-none focus:ring-0 active:bg-sky-800 w-14 sm:w-auto"
      >
